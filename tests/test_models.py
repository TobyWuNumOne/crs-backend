...
from app.infrastructure.database.models.constant import Role, Sex, TimeSlot, RegistrationStatus
...
def test_engine():
    ...
    database_url = os.getenv("DATABASE_URL", "postgresql+psycopg://testuser:testpass@db:5432/testdb")
...
def db_session(test_engine):
    ...
    SessionDb = sessionmaker(autocommit=False, autoflush=False, bind=test_engine, class_=Session)
